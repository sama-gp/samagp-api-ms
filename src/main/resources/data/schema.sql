...
-- 3. Insertion des pays (seulement s'ils n'existent pas)
...
-- 4. Insertion des villes et aéroports pour le Sénégal
-- Dakar
...
-- 5. Insertion des villes et aéroports pour la France
-- Paris
INSERT INTO zones_geos (libelle, type_code, parent_id)
...
-- 6. Insertion des villes et aéroports pour le Maroc
-- Casablanca
INSERT INTO zones_geos (libelle, type_code, parent_id)
...
-- 7. Réactivation des contraintes de clé étrangère
