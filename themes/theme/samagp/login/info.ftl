...
<#macro addNonAutomaticallyGatherableMessagesToXKeycloakifyMessages>
    ...
    <#if requiredActions?? && requiredActions?is_enumerable>
      ...
      <script type="module" crossorigin="" src="${xKeycloakify.resourcesPath}/dist/assets/index-DhctxT5Y.js"></script>
      <link rel="stylesheet" crossorigin="" href="${xKeycloakify.resourcesPath}/dist/assets/index-Ct5hx6sT.css">
    </head>
